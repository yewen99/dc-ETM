...
parser.add_argument('--use_beta', type=bool, default=False, help='whether use rl training method.')
...
# save path
if args.use_policy:
    args.save_path = os.path.join(args.save_path, f'rl_beta_{args.use_beta}_patial:{args.partial_trainer}')
